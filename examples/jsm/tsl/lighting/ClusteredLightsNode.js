...
class ClusteredLightsNode extends LightsNode {
	...
	getLights() {
		...
		// lights and left the node's GPU inputs (light count, cluster
		// contents) inconsistent with its light arrays. Return the full set
		// so the save/restore round-trips.
